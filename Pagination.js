...
function createTable() {
  ...
  thead.setAttribute("class", "table table-dark table-hover");
  thead.setAttribute("id", "theadid");
  let tr = document.createElement("tr");
  let th1 = createTrTd("td");
  th1.innerHTML = "ID";
  let th2 = createTrTd("td");
  th2.innerHTML = "Name";
  let th3 = createTrTd("td", "Email");
  th3.innerHTML = "Email";
...
function createTrTd(elem, elemclass = "", elemId = "") {
  let td = document.createElement(elem);
  td.setAttribute("class", elemclass);
  td.setAttribute("id", elemId);
  return td;
}
function mainFunc() {
  createTable();
...
function updateTable(page) {
  let conEle = document.getElementById("conid");
  let tableEle = document.getElementById("tableid");
  let theadEle = document.getElementById("theadid");
  let tbodyEle = document.getElementById("tbodyid");
  console.log(tbodyEle);
  tbodyEle.innerHTML = "";

  let rowsPerPage = 10;
  let arr = data.slice(page * rowsPerPage - rowsPerPage, page * rowsPerPage);

  arr.forEach((obj) => {
    let tbodytr = document.createElement("tr");
    let tbodytd1 = document.createElement("td");
    tbodytd1.innerHTML = obj.id;
    let tbodytd2 = document.createElement("td");
    tbodytd2.innerHTML = obj.name;
    let tbodytd3 = document.createElement("td");
    tbodytd3.innerHTML = obj.email;
    tbodytr.append(tbodytd1, tbodytd2, tbodytd3);
    tbodyEle.append(tbodytr);

    tableEle.append(theadEle, tbodyEle);
    conEle.append(tableEle);
    console.log(main);
    main.appendChild(conEle);
  });
